...
export default function Home() {
  return (
    <main className='mt-6 container lg:px-[200px] mx-auto px-4  max-h-[calc(100vh-100px)]'>
        ...
        <div className='w-full max-w-md  flex flex-col '>
          ...
          <div className='mt-5 flex flex-col md:flex-row gap-2 md:mt-10 justify-center lg:justify-start'>
            ...
            <Button className='relative border border-primary'>
              <span className='text-main tracking-wide font-light h-full w-full block relative '>
              see projects
              </span>
            </Button>
